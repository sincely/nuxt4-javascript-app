...
<template>
  ...
  >
    <DataCard :event-key="MITT_KEY.CHANGE_TO_DATA" class="col-span-12 col-start-1 md:(col-start-2 col-span-2)">
      ...
      <template #data>182.6k</template>
      <template #descript>Total sales</template>
      <template #subscript>
        <div class="subscript">
    ...
    <DataCard :event-key="MITT_KEY.CHANGE_TO_DATA" class="dataCard">
      ...
      <template #data>38.6k</template>
      <template #descript>Number of sales</template>
      <template #subscript>
        <div class="subscript">
          <span class="i-carbon-caret-up subscript__icon" />
          <span>12.3%</span>
    ...
    <DataCard :event-key="MITT_KEY.CHANGE_TO_DATA" class="dataCard">
      ...
      <template #data>12000+</template>
      <template #descript>Company size</template>
      <template #subscript>
        <div class="subscript">
    ...
    <DataCard :event-key="MITT_KEY.CHANGE_TO_DATA" class="dataCard">
      ...
      <template #data>192</template>
      <template #descript>Number of patents</template>
      <template #subscript>
        <div class="subscript">
          <span class="i-carbon-caret-up subscript__icon" />
          <span>16</span>
    ...
    <DataCard :event-key="MITT_KEY.CHANGE_TO_DATA" class="dataCard">
      ...
      <template #data>8.3%</template>
      <template #descript>Market share</template>
      <template #subscript>
        <div class="subscript">
          <span class="i-carbon-caret-up subscript__icon" />
          <span>2%</span>
