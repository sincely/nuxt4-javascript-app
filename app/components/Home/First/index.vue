  ...
  <div ref="rootRef" class="full">
    ...
    >
      <SwiperSlide>
        ...
        >
          <template #left>
            <div style="font-family: 'Microsoft JhengHei'; font-size: 252px" class="leftText">3</div>
          </template>
        </HomeFirstCarouselHorizontal>
      </SwiperSlide>
      <SwiperSlide>
...
@use '@/styles/swiper/variables' as *;
@use '@/styles/swiper/mixins' as *;
@use '@/styles/swiper/index' as *;
